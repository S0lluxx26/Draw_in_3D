...
import {ShowRecorder} from '../src/show-recorder.js';
import {editableDemo,encodeShow,compileShow} from '../src/show-project.js';
...
test('late video size and encoder failures report errors after stop without downloading',t=>{
  ...
  const track={addEventListener(){},stop(){}},player={active:true,canvas:{clientWidth:800,clientHeight:600,style:{},captureStream:()=>({getTracks:()=>[track]})},camera:{clone:()=>({}),clearViewOffset(){},updateProjectionMatrix(){},copy(){}},orbit:{enabled:true,target:{clone:()=>({}),copy(){}}},renderer:{getPixelRatio:()=>1,setPixelRatio(){},setSize(){}},clock:{rate:1,time:0,pause(){},speed(){},seek(){},play(){}},front(){},render(){},refresh(){},resize(){}};

...
export class ShowEditor{
  ...
  paint(canvas,c,thumbnail=false){
    ...
    try{
      const f=cueFormation(c,thumbnail?256:this.doc.count),paths=placePaths(drawingPaths(c.artwork),c.placement);let minX=-34,maxX=34,minY=0,maxY=46;

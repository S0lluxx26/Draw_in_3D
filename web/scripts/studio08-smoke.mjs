...
try{
  ...
  const url=process.env.DRAW3D_URL||'http://127.0.0.1:5173';await page.goto(url);await page.locator('#undo:disabled').waitFor();assert.equal(await page.locator('.edition').textContent(),'STUDIO 16');

...
try{
  ...
  assert.equal(await page.locator('.edition').textContent(),'STUDIO 08');
  ...
  assert.deepEqual(errors,[]);console.log('PASS: Studio 08 HTTPS editor, project subpath assets, starter scene, bendable surface, desktop/mobile layouts and curve control; zero browser errors.');

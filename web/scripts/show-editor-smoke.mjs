...
try{
  ...
  await page.locator('#show-editor').click();await page.locator('#author-dialog').waitFor({state:'visible'});assert.equal(await page.locator('.author-card').count(),7);
  ...
  await page.locator('#author-duplicate').click();assert.equal(await page.locator('.author-card').count(),8);await page.locator('#author-undo').click();assert.equal(await page.locator('.author-card').count(),7);await page.locator('#author-redo').click();await page.locator('#author-delete').click();assert.equal(await page.locator('.author-card').count(),7);

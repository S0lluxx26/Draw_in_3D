# Make your own drone show — Studio 10
...
1. Click **Edit demo**. You get Robot, Fish and Eiffel Tower as editable drawings, with the original timing and a fireworks finale.
2. Select the Robot card and click **Edit drawing**. Its original strokes open on a hidden drawing guide. Use Select or Box select to change colours or move parts; use Line, Curve, Rectangle, Ellipse or freehand Draw to add details. Undo and Redo work here. **Drone dots** previews the 256 samples over committed strokes.
...
8. Set the fireworks radius and duration, or disable the finale. **Play my show** performs takeoff → your formations → optional light fireworks → return and landing. The same 256 virtual drones persist throughout.
